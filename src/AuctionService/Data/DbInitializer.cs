...
{
    public static void InitiDb(WebApplication app)
    {
        using var scope = app.Services.CreateScope(); /*this will allow the framework,
        once we're finished with this method, to dispose of any of the services we've used inside this scope that we're creating */
    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        context.AddRange(auctions); //This will populate in memory. Entity framework is going to keep the auctions that we add in memory when we use the add range.
